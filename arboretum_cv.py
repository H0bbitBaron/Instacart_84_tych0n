...
#    weights.reset_index(inplace=True)
    ...
    del user_dep_stat, user_aisle_stat, orders, products
    gc.collect()
    ...
    del data_dow, prod_usr_reordered, prod_usr
    gc.collect()
    ...
    del product_embeddings, product_periods
    gc.collect()
